...
export default function EditInterviewPage() {
  ...
  useEffect(() => {
    api<InterviewDetail>(`/admin/contents/${id}`)
      .then((data) => {
        setForm({
  ...
  return (
    <>
      <h1 className="mb-6 text-2xl font-bold text-[#0a1432]">인터뷰 수정</h1>
